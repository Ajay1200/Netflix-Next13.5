...
const MovieCard: React.FC<MovieCardProps> = ({
  ...
  return (
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
        <img src={data.thumbnailUrl} draggable={false} alt="card"
         className="cursor-pointer object-cover transition duration shadow-xl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0
      ...
      >
          <img src={data?.thumbnailUrl} alt="thumb" 
          ...
          <div className="z-10 bg-zinc-800 p-2 lg:p-4 absolute transition shadow-md rounded-b-md">
            <div className="flex flex-row items-center gap-3">
              <div onClick={() => router.push(`/watch/${data?.id}`)} className="cursor-pointer w-6 h-6 lg:w-10 lg:h-10 bg-white rounded-full flex justify-center 
