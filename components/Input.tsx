...
const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className="relative">
        ...
        onChange={onChange}
        id={id}
        className="block rounded-md px-6 pt-6 pb-1 w-full text-md text-white bg-neutral-700
        focus:outline-none focus:ring-0 peer" 
        placeholder=""
        />
        <label className="absolute text-md text-zinc-400 duration-150 transform -translate-y-3 
